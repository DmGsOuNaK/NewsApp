                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="aboutus">
                                ...
                                <p class="aboutus-text">This project has been created by:<br/>Sounak Mandal(20BCE2737), Abhishek Kumar(20BCE2713), Saumya Sejal(20BCE2596), Ishita Kumari(20BCE2648)</p>
                                <p class="aboutus-text">The news app is a comprehensive platform that keeps you updated with the latest news from around the world. With a user-friendly interface and a vast range of news categories, you can stay informed and explore diverse perspectives in just a few clicks.</p>
